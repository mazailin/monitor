...
<div class="page">
	<div class="pageContent">
        <form method="post" action="${BaseURL}${editPage.model}/profile" class="pageForm required-validate" onsubmit="return validateCallback(this, ${openType}AjaxDone)">
            ...
            <div class="pageFormContent" layoutH="58">
                ...
                <label for="__user.account__">账号：</label>
                <input disabled="disabled" id="account" class="required" name="__user.account__" type="text" minlength="4" maxlength="16" value="${editPage.pojo.account}" />
                ...
                <label for="__user.status__">不受权限控制：</label>
                <select disabled="disabled" name="__user.superPower__" class="required">
                    <option value="yes" 
                ...
                <dl class="nowrap">
                	<dt>帐号有效期：</dt>
					<dd>
						<input disabled="disabled" id="account" class="date textInput readonly valid focus" name="__user.availablePeriod__" type="text" readonly="true" value="${editPage.pojo.availablePeriod}" /><!--a class="inputDateButton" href="javascript:void(0);">选择</a-->
					</dd>
				</dl> 
