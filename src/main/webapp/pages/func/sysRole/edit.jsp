...
<form method="post" action="<%=cxt %>/sysRole/update?navTabId=sysRoleLiNav" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
