...
<div class="pageHeader">
	<form rel="pagerForm" method="get" action="${BaseURL}${listPage.model}/lookupSearch" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<table class="table" layoutH="118" targettype="dialog" width="100%">
		...
		<tbody>
			...
			<tr>
				<td>${pojo.navMenuId}</td>
				<td>${pojo.name}</td>
				<td>${pojo.href}</td>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({navMenuId:'${pojo.navMenuId}', name:'${pojo.name}'})" title="查找带回">选择</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
	...
	<div class="panelBar">
		...
		<form id="pagerForm" method="get" action="${BaseURL}${listPage.model}/lookupSearch">
