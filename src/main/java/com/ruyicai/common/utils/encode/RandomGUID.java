...
public class RandomGUID {
	...
	public String toString() {
		 ...
		 * sb.append("-"); sb.append(raw.substring(8, 12)); sb.append("-");
		 * sb.append(raw.substring(12, 16)); sb.append("-");
		 * sb.append(raw.substring(16, 20)); sb.append("-");
	...
	public static String randomNumberString(int bits) {
		...
		for (int i = 0; i < bits; i++) {
			...
			s += String.valueOf(d).substring(2);
		}
		while (s.charAt(0) == '0') {
			s = s.substring(1);
		}
